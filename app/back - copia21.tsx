  ...
  return (
    <main className="min-h-screen relative font-sans overflow-x-hidden bg-slate-900">
      <style jsx global>{`
        ...
        /* HEADER NUEVO ESTILO HERO */
        .topbar-hero {
          background:
            linear-gradient(180deg, rgba(255,255,255,0.82), rgba(255,255,255,0.62)),
            radial-gradient(circle at top left, rgba(0,102,255,0.18), transparent 32%),
            radial-gradient(circle at top right, rgba(255,180,0,0.20), transparent 34%);
        ...
        .brand-amazon {
          ...
          text-shadow:
            ...
            0 2px 0 #9bc7ff,
            0 4px 0 #004bbd,
            0 7px 14px rgba(0,102,255,0.45);
        }
        ...
        .brand-py {
          ...
          text-shadow:
            ...
            0 2px 0 #ffe98a,
            0 4px 0 #cc8d00,
            0 7px 14px rgba(244,196,0,0.50);
        }
        ...
        .search-hero:focus {
          ...
          box-shadow:
            inset 0 3px 8px rgba(0,0,0,0.10),
            0 0 0 5px rgba(0,102,255,0.22),
            0 12px 24px rgba(0,102,255,0.16);
        }
        ...
        .nav-action-btn::before {
          ...
          height: 35%;
          border-radius: 999px;
          background: linear-gradient(180deg, rgba(255,255,255,0.70), rgba(255,255,255,0.05));
          pointer-events: none;
        }
        ...
        .nav-panel-btn {
          background: linear-gradient(135deg, #1F8BFF 0%, #0066FF 48%, #1437D9 100%);
        }

        .nav-login-btn {
          background: linear-gradient(135deg, #12D88F 0%, #0BAF73 45%, #066A48 100%);
        }
        ...
        .nav-logout-btn {
          background: linear-gradient(135deg, #FF5D7A 0%, #EF174B 48%, #B90F35 100%);
          padding: 9px 14px;
          font-size: 11px;
        }
        ...
        .nav-icon-dot {
          ...
          justify-content: center;
          background:
            radial-gradient(circle at 35% 25%, rgba(255,255,255,0.95), rgba(255,255,255,0.20) 38%, rgba(0,0,0,0.12) 100%);
          box-shadow:
        ...
        /* FOOTER NUEVO PREMIUM */
        .footer-magic {
          position: relative;
          overflow: hidden;
          background:
            radial-gradient(circle at 12% 18%, rgba(255,122,0,0.24), transparent 28%),
            radial-gradient(circle at 82% 20%, rgba(0,209,255,0.25), transparent 30%),
            radial-gradient(circle at 55% 88%, rgba(168,85,247,0.20), transparent 34%),
            linear-gradient(180deg, rgba(5,10,30,0.96), rgba(7,15,42,0.98));
        ...
        .footer-glow-line {
          height: 5px;
          background: linear-gradient(90deg, #ff7a00, #f4c400, #00d084, #00aaff, #a855f7, #ff2d75);
          box-shadow:
        ...
        .footer-brand-card {
          ...
          background:
            ...
            radial-gradient(circle at top left, rgba(255,180,0,0.28), transparent 35%);
        ...
        .footer-title-3d {
          ...
          text-shadow:
            ...
            0 2px 0 #9bc7ff,
            0 4px 0 #004bbd,
            0 8px 18px rgba(0,102,255,0.55);
        }
        ...
        .footer-title-py {
          ...
          text-shadow:
            ...
            0 2px 0 #ffe98a,
            0 4px 0 #b88700,
            0 8px 18px rgba(244,196,0,0.55);
        }
        ...
        .footer-mini-dot {
          ...
          justify-content: center;
          background:
            radial-gradient(circle at 35% 25%, rgba(255,255,255,0.92), rgba(255,255,255,0.20), rgba(0,0,0,0.10));
          box-shadow:
        ...
        .footer-contact-blue {
          background: linear-gradient(135deg, #1f8bff, #0066ff, #1437d9);
        }

        .footer-contact-cyan {
          background: linear-gradient(135deg, #00b7ff, #0088cc, #005f99);
        }

        .footer-contact-green {
          background: linear-gradient(135deg, #2dd46f, #13a852, #08753a);
        }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-stretch">
              ...
              <div className="footer-box">
                ...
                <ul className="space-y-3">
                  <li>
                    <Link href="/nosotros" className="footer-pill-link">
                  ...
                  <li>
                    <Link href="/premium" className="footer-pill-link">
                      <span className="footer-mini-dot">⭐</span>
                      <span>Ser Premium</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/ayuda" className="footer-pill-link">
                      <span className="footer-mini-dot">💬</span>
